...
\usepackage{hyperref}
\usepackage{geometry}
\usepackage{etaremune} %for reverse numerate listing
...
\begin{tabular}{ p{2.5cm} p{13cm} }
   ...
   &{\it Master of Public Administration}\\
   & \\
...
\begin{itemize}
\item Public \& Nonprofit Management, Ethical Decision Making in Public and Nonprofit Organizations, Methodology.
\end{itemize}
...
\begin{itemize}
	\item Research Design (\textit{In person \& Online})
	\item Foundations of Public Administration (\textit{In person \& Online})
	\item Economic Analysis (\textit{In person \& Online})
\end{itemize}

\subsection*{Rutgers University-Newark}
\subsubsection*{Undergraduate level}
\begin{itemize}	
\item Introduction to Nonprofit Administration (\textit{In person})
\end{itemize}

\subsubsection*{Graduate level}
\begin{itemize}	
\item Applied Research Design (\textit{In person \& Online})
\end{itemize}
...
\begin{minipage}{0.45\linewidth}
    ...
    Phone: (202)-687-0100 \\
    Email: \href{mailto: sebastian.jilke@georgetown.edu}{\tt  sebastian.jilke@georgetown.edu} \\
\end{minipage}
